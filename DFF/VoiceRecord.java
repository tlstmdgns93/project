...
public class VoiceRecord extends AppCompatActivity  implements View.OnClickListener,OnCompletionListener, AdapterView.OnItemSelectedListener {
    ...
    private Button mBtnStartRec, mBtnStartPlay, mBtnDelRec, mBtnSetVoice;
    ...
    private void mBtnSetVoiceOnClick() {
        try {
            ...
            editor.commit();
            Toast.makeText(VoiceRecord.this, "저장이 완료되었습니다.", Toast.LENGTH_SHORT).show();
                ...
                .setNegativeButton("확인",
                        new DialogInterface.OnClickListener() {
                            public void onClick(
                               ...
                               /* for(int i=0; i<files.length; i++)
                                {
                                    if( mFileName.equals(files[i].toString()) ) //파일의 이름이 겹칠때
                                    {

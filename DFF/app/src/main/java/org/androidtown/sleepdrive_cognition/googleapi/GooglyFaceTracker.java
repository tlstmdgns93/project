...
class GooglyFaceTracker extends Tracker<Face> {
    ...
    public static boolean s_left;
    public static boolean s_right;
    public static float face_checking;
    private static final float EYE_CLOSED_THRESHOLD = 0.4f;

    private GraphicOverlay mOverlay;
    private GooglyEyesGraphic mEyesGraphic;
    private GooglyEyesActivity mGooglyEyesActivity = new GooglyEyesActivity();
    ...
    public void onNewItem(int id, Face face) {
        //  mEyesGraphic = new GooglyEyesGraphic();
    ...
    public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
        ...
        //mEyesCloses.EyesChecking(isLeftOpen,  isRightOpen);
        //EyesChecking(isLeftOpen,isRightOpen);
        //mGooglyEyesActivity
        if(isLeftOpen)
        Log.d("D3", "트래커 왼쪽 : " + s_left + " 트래커 오른쪽 : "+ s_right + " 레프트 스코어 :" + leftOpenScore);
        face_checking=leftOpenScore;
        s_left=isLeftOpen;
        s_right=isRightOpen;
        //((GooglyEyesActivity)GooglyEyesActivity.mContext).EyesChecking(isLeftOpen,isRightOpen);
        //        //Log.d("D2","isLeftOpen : " + isLeftOpen + "isRightOpen : " + isRightOpen);
    }
    /**

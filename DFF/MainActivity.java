...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button driving = (Button) findViewById(R.id.driving_button);
        Button restarea_search = (Button) findViewById(R.id.restarea_search_button);
        ...
        driving.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // intent.setClassName("com.google.android.gms.samples.vision.face.googleapi", "com.google.android.gms.samples.vision.face.googleapi.GooglyEyesActivity");
                ...
                //   Intent intent = new Intent(getApplicationContext(), FaceCognition.class);
             //   startActivityForResult(intent,110);
           //     Intent intent = new Intent("arabiannight.driving.intentfilter.view");
                // intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
           //     startActivity(intent);

                //intent.setFlags(intent.FLAG_ACTIVITY_NEW_TASK);
               // intent.setComponent(new ComponentName("googlyeyes", "googlyeyes.GooglyEyesActivity"));
